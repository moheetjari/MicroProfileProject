...
public class UsersManagedBean {
    ...
    public UsersManagedBean() {
        System.out.println("Hello Users Bean ");
        ...
        ujc = new UsersJerseyClient(token);
//        init();
...
//    {
//        Response response = ujc.getAllUser(Response.class);
...
//        Users u = response.readEntity(gUser);
        Users u = client.getUserById(Integer.parseInt(uid));
...
//            ujc.addUser(name, phno, password, interest, gender, email, city, bdate);
            client.addUser(name, email, phno, interest, gender, birthdate, city, password);
            //have to check birthdate, whether date type is working or not
    ...
    public void onRowEditUser(RowEditEvent<Users> event) {
        ...
        client.updateUser(event.getObject().getUserId(), event.getObject().getName(), event.getObject().getEmail(), event.getObject().getPhoneNumber(), event.getObject().getInterest(), event.getObject().getGender(), event.getObject().getBirthdate(), event.getObject().getCity());
        //have to check birthdate, whether date type is working or not
    }
...
//            System.out.println(bdate);
    ...
    public String deleteUser(String uid) {
        //ujc.deleteUser(uid);
        client.removeUser(Integer.parseInt(uid));
        return "/Admin/userindex.xhtml?faces-redirect=true";
    }
